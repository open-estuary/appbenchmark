...
public class YarnConfiguration extends Configuration {
  ...
  */
  ...
  public static final String NM_NUMA_AWARENESS_NODE_MEMORY = NM_PREFIX
      + "numa-awareness.<NODE_ID>.memory";
  public static final String NM_NUMA_AWARENESS_NODE_CPUS = NM_PREFIX
      + "numa-awareness.<NODE_ID>.cpus";
