...
import org.apache.hadoop.yarn.server.nodemanager.numa.AssignedNumaNodeInfo;
...
public class LinuxContainerExecutor extends ContainerExecutor {
  ...
  private void addNumaAwarenessParams(List<String> command,
      Container container) {
    if (YarnConfiguration.numaAwarenessEnabled(getConf())) {
  ...
  public void startLocalizer(Path nmPrivateContainerTokensPath,
    ...
    //addNumaAwarenessParams(prefixCommands, container);
