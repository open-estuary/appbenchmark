...
public class NodeManager extends CompositeService 
  ...
  protected void serviceInit(Configuration conf) throws Exception {
    ...
    if (YarnConfiguration.numaAwarenessEnabled(conf)) {
      NUMAResourcesManager numaNodesScheduler = new NUMAResourcesManager();
      addService(numaNodesScheduler);
      containerManager.setNumaNodesScheduler(numaNodesScheduler);
      exec.setNumaResourcesManager(numaNodesScheduler);
    }
