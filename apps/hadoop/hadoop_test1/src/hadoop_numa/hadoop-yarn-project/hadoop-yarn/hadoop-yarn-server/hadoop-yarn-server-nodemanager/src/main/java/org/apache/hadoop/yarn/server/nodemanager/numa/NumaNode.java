...
/**
 * NumaNode class holds the NUMA node topology with the total and used
 * resources.
 */
public class NumaNode {
  ...
  public synchronized boolean isResourcesAvailable(Resource resource) {
    LOG.info(
  ...
  public synchronized long assignAvailableMemory(long memreq,
  ...
  public synchronized int assignAvailableCpus(int cpusreq,
      ContainerId containerId) {
  ...
  public synchronized void assignResources(Resource resource,
      ContainerId containerId) {
  ...
  public synchronized void releaseResources(ContainerId containerId) {
