...
${APP_ROOT}/apps/mariadb/mariadb_1/scripts/start_server.sh init
${APP_ROOT}/apps/mariadb/mariadb_1/scripts/start_server.sh start
...
ps -aux | grep mariadbd | grep -v grep | awk '{print $2}' | xargs -n 1 taskset -pac 10-63
echo "Start orzdba and tcprstat to catpure latency ......"
orzdba -mariadb -i 10 -rt -c -L ${log_name} > /dev/null 2>&1 &
