...
BUILD_ESSENTIAL="build-essential automake cmake git libtool bzr"
...
if [ "$(which yum 2> /dev/null)" ] ; then 
    ...
    BUILD_ESSENTIAL="automake cmake git libtool bzr"
fi
...
#Add special package for mariadb-server build
