...
#${APP_ROOT}/apps/mysql/alisql/scripts/readall.sh $1 $2 $3  47 3306
${APP_ROOT}/apps/mysql/alisql/scripts/readall.sh $1 $2 $3  ${default_table_count}

elif [ "$4" == "test" ] ; then
#${APP_ROOT}/apps/mysql/alisql/scripts/sysbench.sh $1 $2 $3 on 1 90 $1 sysbench 100 1000000 select6 20000
#${APP_ROOT}/apps/mysql/alisql/scripts/sysbench.sh $1 $2 $3 on 2 180 $1 sysbench 100 1000000 select6 20000
#${APP_ROOT}/apps/mysql/alisql/scripts/sysbench.sh $1 $2 $3 on 3 270 $1 sysbench 100 1000000 select6 20000
#${APP_ROOT}/apps/mysql/alisql/scripts/sysbench.sh $1 $2 $3 on 4 360  $1 sysbench 100 1000000 select6 20000
#${APP_ROOT}/apps/mysql/alisql/scripts/sysbench.sh $1 $2 $3 on 50 450 $1 sysbench 100 1000000 select6 100000
#${APP_ROOT}/apps/mysql/alisql/scripts/sysbench.sh $1 $2 $3 on 500 450 $1 sysbench 100 1000000 select6 100000

inst_num=${5}
${APP_ROOT}/apps/mysql/alisql/scripts/sysbench_lots_instances.sh ${inst_num}
