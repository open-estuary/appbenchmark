...
do
    ...
    taskset -c ${start_cpu_num} ${TWEMPROXY_INSTALL_DIR}/twemproxy -d -c ${TWEMPROXY_CFG_DIR}/nutcracker_${start_cpu_num}.yml -v 4 -s ${twemproxy_portid} -m 1024 -o twemproxy_${start_cpu_num}.log
