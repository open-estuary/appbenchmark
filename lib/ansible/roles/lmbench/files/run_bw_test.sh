...
echo "*******************core0***********************"
perform_bandwidth_test "numactl --localalloc -C" 1 0

echo "*******************cluster0********************"
perform_bandwidth_test "numactl --localalloc -C" 4 "0-3"

echo "*******************Die0************************"
perform_bandwidth_test "numactl --localalloc -C" 16 "0-15"

echo "*******************1P*************************"
perform_bandwidth_test "numactl --localalloc -C" 32 "0-31"
